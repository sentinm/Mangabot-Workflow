...
RUN apt update && apt install -y make python python3-pip build-essential curl git wget openssh-client openssh-server tmate patchelf python3 gzip aria2 tar php bash nano vim locales-all p7zip figlet unzip brotli megatools libfuse2
