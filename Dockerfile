...
RUN apt update && apt install -y make python build-essential curl git wget openssh-client openssh-server tmate patchelf python3 gzip tar php bash locales-all p7zip figlet unzip brotli megatools
